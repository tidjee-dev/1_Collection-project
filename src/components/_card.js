const card = (ref, category, name, picture, pieceCount, minifigCount, weight, releaseYear, links) => {
    ...
    <div class="card-body">
      ...
      <div class="card-link-container">
        ...
        <a class="card-link-item" href="${links.lego}" target="_blank" rel="noopener noreferrer">LEGO</a>
        <a class="card-link-item" href="${links.bricklink}" target="_blank" rel="noopener noreferrer">Bricklink</a>
      </div>
    </div>
  `;
    return card;
